...
export const FIELD_TO_STATE_SETTER = {
  ...
  shadowDiffuse:         'setShadowDiffuse',
  lightHemiEnabled:      'setLightHemiEnabled',
  lightKeyEnabled:       'setLightKeyEnabled',
  lightFillEnabled:      'setLightFillEnabled',
  lightSpotEnabled:      'setLightSpotEnabled',
  lightKeyFixedToCamera: 'setLightKeyFixedToCamera',
  lightFillFixedToCamera:'setLightFillFixedToCamera',
  lightSpotFixedToCamera:'setLightSpotFixedToCamera'
};

// Mapping light name → setter names on window.appState
export const LIGHT_POS_SETTERS = {
  lightKeyPos:  { setPos: 'setLightKeyPos',  setFixed: 'setLightKeyFixedToCamera' },
  lightFillPos: { setPos: 'setLightFillPos', setFixed: 'setLightFillFixedToCamera' },
  lightSpotPos: { setPos: 'setLightSpotPos', setFixed: 'setLightSpotFixedToCamera' }
};
